...
import { fetchRawHoursTimeSeriesData } from '@/lib/dashboard/rawChartData'
...
export async function GET(
  ...
  try {
    ...
    const chartData = await fetchRawHoursTimeSeriesData(
      accountId,
      granularity,
      {
        productNames,
    ...
    console.error('Error fetching hours chart data:', error)
