...
import { fetchRawUsersTimeSeriesData, EventsChartFilters } from '@/lib/dashboard/rawChartData'
...
export async function GET(
  ...
  try {
    ...
    const filters: EventsChartFilters = {
      startDate: startDateParam || null,
      endDate: endDateParam || null,
      productNames,
    }

    const chartData = await fetchRawUsersTimeSeriesData(accountId, granularity, filters, supabase)
